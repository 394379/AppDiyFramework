...
class Cms extends Base
{
    ...
    public function productAdd()
    {
        ...
        if(request()->isPost()){
            ...
            if($result==null){
                ...
                $this->success('产品添加成功','cms/cms/cmsList','','1');
            }
        }else {
    ...
    public function productEdit()
    {
        ...
        if(request()->isPost()){
            ...
            if($result==null){
                ...
                $this->success('产品更新成功','cms/cms/cmsList','','1');
            }
        }else {
    ...
    public function setTop()
    {
        $this->noLogin();
        $id = Request::param('id');
        if(articleModel::where('id',$id)->update(['is_top'=>1])!=''){
            $this->success('置顶成功!','cms/cms/cmsList','','1');
        }
    }
    public function unSetTop()
    {
        $this->noLogin();
        $id = Request::param('id');
        if(articleModel::where('id',$id)->update(['is_top'=>0])!=''){
            $this->success('取消置顶成功!','cms/cms/cmsList','','1');
        }
    }
    //置顶
    public function setHot()
    {
        $this->noLogin();
        $id = Request::param('id');
        if(articleModel::where('id',$id)->update(['is_hot'=>1])!=''){
            $this->success('设置热点成功!','cms/cms/cmsList','','1');
        }
    }
