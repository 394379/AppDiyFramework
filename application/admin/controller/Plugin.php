...
//        $url = "http://api.ycsoft.cm/index/plugin";
    ...
    public function install()
    {
        ...
        $url = 'http://dapi.yc78.com/uploads/'.$resInfo[0]['verzip'][0]['url'];
    ...
    public function orderpay(){
        ...
        $apiUrl = 'http://dapi.yc78.com/index/pay/';
    ...
    {
        $url = "http://dapi.yc78.com/index/pay/orderpay?order_id=".input($order_id);
        $httpService = new HttpService();
        $resInfo = $httpService->download($url);
        echo $resInfo;
    }
